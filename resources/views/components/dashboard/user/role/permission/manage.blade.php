...
<script>
    ...
    function setListenerToDeletePermission() {
        document.querySelectorAll('#permissionListUser button').forEach(b => {
            b.addEventListener('click', function() {
                ...
                axios.post('{{ route('user.delete.permission', ['user' => $user->id]) }}', {
                    'permission': perId
                }).then((res) => {
    ...
    function assignPermissionToUser() {
        ...
        axios.post('{{ route('user.assign.permission', ['user' => $user->id]) }}', {
            'permission': perId
        }).then((res) => {
...
<script>
    ...
    function assignRoleToUser() {
        ...
        axios.post('{{ route('user.assign.role', ['user' => $user->id]) }}', {
            'role': roleId
        }).then((res) => {
    ...
    function setListenerToDeleteRole() {
        document.querySelectorAll('#rolesListUser button').forEach(b => {
            b.addEventListener('click', function() {
                ...
                axios.post('{{ route('user.delete.role', ['user' => $user->id]) }}', {
                    'role': roleId
                }).then((res) => {
